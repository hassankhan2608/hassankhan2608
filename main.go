...
<svg xmlns="http://www.w3.org/2000/svg" font-family="'JetBrains Mono','Fira Code','Cascadia Code','Courier New',monospace" width="910px" height="580px" font-size="16px">
<style>
  .key {fill: %s;}
  .val {fill: %s;}
  .add {fill: %s;}
...
<rect width="910" height="540" fill="%s" rx="15"/>
...
<text x="20" y="410" fill="%s">
  <tspan x="20" y="410" class="key">Contact</tspan>:
  <tspan x="20" y="430">———————</tspan>
  <tspan x="20" y="450" class="key">Email</tspan>: <tspan class="val">hassankhan2608@gmail.com</tspan>
  <tspan x="20" y="470" class="key">LinkedIn</tspan>: <tspan class="val">/in/hassankhan2608</tspan>
  <tspan x="20" y="490" class="key">X</tspan>: <tspan class="val">@hassankhan2608</tspan>
  <tspan x="20" y="510" class="key">Web</tspan>: <tspan class="val">laughingman.is-a.dev</tspan>
</text>

<text x="400" y="410" fill="%s">
  <tspan x="400" y="410" class="key">GitHub Stats</tspan>:
  <tspan x="400" y="430">————————————</tspan>
  <tspan x="400" y="450" class="key">Repos</tspan>: <tspan class="val">%s</tspan> {<tspan class="key">Own</tspan>: <tspan class="val">%s</tspan>} | <tspan class="key">Stars</tspan>: <tspan class="val">%s</tspan>
  <tspan x="400" y="470" class="key">Commits</tspan>: <tspan class="val">%s</tspan> | <tspan class="key">Issues</tspan>: <tspan class="val">%s</tspan> | <tspan class="key">PRs</tspan>: <tspan class="val">%s</tspan>
  <tspan x="400" y="490" class="key">Lines of Code</tspan>: <tspan class="val">%s</tspan> (<tspan class="add">%s++</tspan>, <tspan class="del">%s--</tspan>)
</text>
